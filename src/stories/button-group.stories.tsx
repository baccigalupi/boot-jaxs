  ...
  render: () =>
    renderJaxs(
      <ButtonGroup ariaLabel="Basic mixed styles example">
        <Button variant="danger" onClick="on-click">
          Left
        </Button>
        <Button variant="warning" onClick="on-click">
          Middle
        </Button>
        <Button variant="success" onClick="on-click">
          Right
        </Button>
      </ButtonGroup>,
    ),
  ...
  render: () =>
    renderJaxs(
      <ButtonGroup ariaLabel="Basic outlined example">
        <Button variant="primary" outline={true} onClick="on-click">
          Left
        </Button>
        <Button variant="primary" outline={true} onClick="on-click">
          Middle
    ...
    renderJaxs(
      <ButtonToolbar ariaLabel="Toolbar with button groups">
        ...
        <ButtonGroup class="me-2" ariaLabel="Second group">
          <Button variant="secondary" onClick="on-click">
            5
          </Button>
          <Button variant="secondary" onClick="on-click">
            6
        ...
        <ButtonGroup ariaLabel="Third group">
          <Button variant="info" onClick="on-click">
            8
          </Button>
        </ButtonGroup>
      </ButtonToolbar>,
